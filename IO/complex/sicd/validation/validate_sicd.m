...
% 2.12.5
if isfield(SICD_meta.ImageFormation,'TxRcvPolarizationProc') && isfield(SICD_meta.RadarCollection,'RcvChannels')
...
if isfield(SICD_meta,'Timeline') && isfield(SICD_meta.Timeline,'IPP') 
    for i = 1:numel(SICD_meta.Timeline.IPP.Set)
        ...
        if isfield(SICD_meta.Timeline.IPP.Set(i),'IPPPoly')
